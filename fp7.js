...
const numbers = [1, 4, 9];
const roots = numbers.map((num, index, array) => {
  console.log(`num: ${num}, index: ${index}, array: ${array}`);
  return Math.sqrt(num);
});

In this example, 
we’re logging the current element being processed in the array (num), its index (index), and the array itself (array). 
The resulting array will be [1, 2, 3].
*/
